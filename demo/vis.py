...
def show3Dpose(vals, ax): #vals:shape:(17,3),17頂点x,y,z:3方向
    ...
    for i in range(len(vals)):
        x,y,z = vals[i]
        print("joint_id:{},(x,y,z)=({:.3f},{:.3f},{:.3f})".format(i,x,y,z))
...
def get_pose3D(video_path, output_dir): #shape:(17,3)
    ...
    for i in tqdm(range(video_length)):
        ...
        post_out[:, 2] -= np.min(post_out[:, 2]) #shape:(17,3)
